  ...
  return (
    <div className="min-h-screen w-full bg-[#07190e] flex flex-col items-center justify-center pt-24">
      <div className="bg-[#10241b] rounded-2xl shadow-2xl p-12 max-w-2xl w-full flex flex-col items-center">
        ...
        <a href="/Tafadzwa (Aubrey) Tsambatare - Resume.pdf" download className="px-6 py-2 rounded bg-green-700 text-white font-semibold hover:bg-green-600 transition shadow">Download Resume (PDF)</a>
      </div>
    </div>
  );
} 