          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            >
              <div className="relative">
                <div className="text-2xl sm:text-3xl font-display font-black text-gradient group-hover:scale-110 transition-transform">
                  AT
                </div>
                <div className="absolute -inset-1 sm:-inset-2 bg-gradient-primary rounded-lg blur-lg opacity-0 group-hover:opacity-30 transition-opacity" />
              </div>
            </div>
            ...
            <div className="hidden md:block">
              <Button 
                className="bg-gradient-primary hover:shadow-glow-primary transition-all duration-300 font-semibold px-4 sm:px-6 py-2 sm:py-3 hover-lift group"
          ...
          <div className="md:hidden absolute top-full left-0 w-full glass-strong backdrop-blur-3xl border-t border-white/10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
              <div className="space-y-3 sm:space-y-4">
                ...
                <Button 
                  className="w-full bg-gradient-primary hover:shadow-glow-primary transition-all duration-300 font-semibold mt-4 sm:mt-6 animate-pulse"
                  onClick={() => {
                    window.open('/Tafadzwa (Aubrey) Tsambatare - Resume v.09232025.pdf', '_blank');
                    setIsOpen(false);
                  }}
                >
